...
<header class="z-50 sticky top-0 ">
    <div class="backdrop-blur-xl backdrop-brightness-90 absolute h-16 border-b-2 border-gray-600 flex w-full shadow-lg justify-evenly items-center flex-row-reverse">
